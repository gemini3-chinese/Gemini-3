# Gemini 中文版：Gemini 3.0 Pro 国内使用指南~（支持 Gemini-2.5-pro，无需翻墙）【2025年更新】
...
- [ai.lanjingai.org](https://ai.lanjingai.org/) - **Gemini 中文站**，支持 gemini-2.5-pro、claude 4 sonnet、Grok 4、GPT-5、4o、o1、o3 及 DeepSeek R1 最先进的模型，无限使用~
- [chat.yixiaai.com](https://xsimplechat.com/) - **Gemini 中文版**，支持 gemini-2.5-pro、claude-4-sonnet、GPT-5、o1、o3 及 Grok-4，支持 AI 绘画，扫码即可使用。
